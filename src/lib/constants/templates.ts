...
export const lipSyncWorkflow = [
  "用户上传视频（MP4/MOV/WebM，最长30秒，最大50MB）",
  "输入新口播文案（中英文皆可，最多300字）",
  "选择声音风格（男声/女声/新闻腔/亲切/激昂）",
  "Edge TTS 把文字转成音频文件",
  "音频时长自动计算，超过原视频则提示缩短文案",
...
const previewByCategory: Record<TemplateCategory, string> = {
  style_transfer: "/templates/style-transfer.png",
  photo_style: "/templates/photo-style.png",
  portrait: "/templates/portrait.png",
  creative: "/templates/creative.png",
  utility: "/templates/utility.png",
  video: "/templates/video.png",
